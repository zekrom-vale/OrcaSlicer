...
"    ⚠ Using M and C together is not recommended — M targets preamble/suffix while\n"
"      C targets color chunks within layers. These are mutually exclusive scopes.\n\n"
"CHUNKING DETAILS\n"
"═══════════════════════════════════════════════════════════\n"
"  G-code is split into chunks at these boundaries:\n\n"
"  1. ; EXECUTABLE_BLOCK_START — starts layer 0. The match line belongs to\n"
"     layer 0 (not the preamble). The first ;LAYER_CHANGE after\n"
"     EXECUTABLE_BLOCK_START is skipped as a layer boundary, since the\n"
"     Height tag for layer 0 appears after it.\n\n"
...
"  Chunk hierarchy: Preamble → Layer 0 → Layer 1 → ... → Last Layer → Suffix\n"
